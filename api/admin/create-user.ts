...
import { firebaseConfig, getAdminApp, firestoreRest } from "../../lib/firebaseAdmin.js";
...
export default async function handler(req: CustomRequest, res: any) {
  ...
  try {
    ...
    try {
      ...
      if (!currentAdminApp || !isFullAdmin) throw new Error("Hành động này yêu cầu Service Account.");
